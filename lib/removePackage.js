...
module.exports = (packageName) => {
  ...
  // parse and rewrite the lock file
  let lockJson = fs.readJsonSync(packageLock);
  delete lockJson.packages['node_modules/' + packageName];
  delete lockJson.dependencies[packageName];
  fs.writeJsonSync(packageLock, lockJson);
};
